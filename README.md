<img src="https://raw.githubusercontent.com/d3/d3-geo/master/img/equirectangular.png" title="GeoTweets" alt="GeoTweets logo" href="">

# GeoTweets
> WebApp that allows you to see tweet activity wolrdwide.
...
- use `cd geotweets` to enter the main folder
...
- Clone this repo to your local machine using git typing this in your cosole: `git clone https://github.com/aecheverrir/geotweets.git`
